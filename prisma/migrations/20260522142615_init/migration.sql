...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'SUCCESS', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "UserOwnership_userId_idx" ON "UserOwnership"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "UserOwnership_userId_productId_key" ON "UserOwnership"("userId", "productId");
...
-- AddForeignKey
ALTER TABLE "UserOwnership" ADD CONSTRAINT "UserOwnership_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserOwnership" ADD CONSTRAINT "UserOwnership_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserOwnership" ADD CONSTRAINT "UserOwnership_skuId_fkey" FOREIGN KEY ("skuId") REFERENCES "SKU"("id") ON DELETE CASCADE ON UPDATE CASCADE;
